    ...
    <div class="white_box QA_section card_height_100">
        <div class="white_box_tittle list_header m-0 align-items-center">
            <div class="main-title mb-sm-15">
                <h3 class="m-0 nowrap">Tanim na Palay</h3>
            </div>
        ...
        <table class="table lms_table_active2 ">
            <thead>
                <tr>
                    <th scope="col">ID ng Palayan</th>
                    <th scope="col">Pangalan ng Palayan</th>
                    <th scope="col">Variety ng Tanim</th>
                    <th scope="col">Araw ng Tanim</th>
