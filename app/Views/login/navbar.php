...
<head>
	...
	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="<?= base_url() ?>assets_landingpage/img/favicon.png">
	<!-- google font -->
					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="/shop"  style="color: orange">Shop</a></li>
								<li><a href="#"  style="color: orange">About</a>
									
								</li>
								<li><a href="#" style="color: orange">Contact</a>
									
								</li>
								<li><a href="/login"  style="color: orange">Login</a></li>
								<li><a href="/register"  style="color: orange">Register</a>
